...
<div class="container">
    ...
    while ($row = $mResult->fetch_assoc()){
        ...
        <div class="card-body">
            ...
            <a href="waste/edit-waste.php' . $row['materialID'] . '" class="btn btn-primary">Edit Waste</a>
            <a href="waste/delete-waste.php' . $row['materialID'] . '" class="btn btn-danger">Delete Waste</a>
        </div>
        </div>';
    }
    //close conn
